...
-- QUE 5 : List the top 5 most ordered pizza types 
...
-- QUE 6 : Join the necessary tables to 
...
-- QUE 10 : Determine the top 3 most ordered 
...
group by orders.order_date) as sales_daily;

-- QUE 13 : Determine the top 3 most ordered pizza types 
